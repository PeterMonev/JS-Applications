...
let navigationTemplate = () => html`<a href="/" class="site-logo"
    >Team Manager</a
  >
  <nav>
    <a href="/browse" class="action">Browse Teams</a>
    <a style=${isLogged() ? "display:none" : ""} href="/login" class="action"
      >Login</a
    >
    <a style=${isLogged() ? "display:none" : ""} href="/register" class="action"
      >Register</a
    >
    <a style=${isLogged() ? "" : "display:none"} href="myTeams" class="action"
      >My Teams</a
    >
    <a
      @click=${logoutUser}
