...
import { endPoints, getDataFromServer } from "../data/api.js";
import { repeat } from "lit-html/directives/repeat.js";
import { until } from "lit-html/directives/until.js";

let browseTemplate = (data, isLogged, countTeamMembers) => html` <section
  id="browse"
>
  ...
  ${repeat(
    data,
    (team) => team._id,
    (team) => html`<article class="layout">
      <img src=${team.logoUrl} class="team-logo left-col" />
      <div class="tm-preview">
        <h2>${team.name}</h2>
        <p>${team.description}</p>
        <span class="details"
          >${until(countTeamMembers(team), "Loading...")} Members</span
        >
