...
let books = Object.entries(await getAllBooks()).map((e) =>
...
function update() {
  render(
    repeat(books, (book) => book.id, bookTemplate.bind(null, onEdit, onDelete)),
...
function onEdit(book) {
  render(
    [table(update), formEdit(book, onEditSubmit)],
